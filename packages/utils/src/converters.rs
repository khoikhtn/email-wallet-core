...
pub fn field2string(field: &Fr) -> String {
    U256::from_little_endian(field.to_bytes().as_ref()).to_string()
}
...
mod tests {
    use halo2curves::ff::PrimeField;
    use crate::converters::{field2string, hex2field};
    use poseidon_rs::Fr;

    #[test]
    fn test() {
        let a = hex2field("0xfcf0e8f22bdf89e7c24f406384488b8792eca00d02df8f25818c8871e700").unwrap();
